...
import com.panchuk.tax.dao.mysql.util.DBCPDataSource;
    ...
    public List<TaxType> findTaxByFilter(String query) {
        ...
        try (Connection con = DBCPDataSource.getConnection()) {
            ...
            if (query.startsWith(ProjectConstant.FIND_BY_TYPE)) {
                ...
                boolean isSortByDate = Reader.inputIsTrue("Do you want to sort tax by date (\"yes\" or \"no\"): ");
                boolean isAsc = Reader.inputIsTrue("Do you want to sort tax by ascending order (\"yes\" or \"no\"): ");
