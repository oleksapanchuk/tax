...
public class ValidatorTest {
    ...
    @ParameterizedTest
    @MethodSource("testCasesDoubleInput")
    void testInputDouble(String input, boolean expected) {
        assertEquals(expected, Validator.validationDouble(input));
    }
    ...
    static Stream<Arguments> testCasesDoubleInput() {
        return Stream.of(
                Arguments.of("0", true),
                Arguments.of("double", false),
